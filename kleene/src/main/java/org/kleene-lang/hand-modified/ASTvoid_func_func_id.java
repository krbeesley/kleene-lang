...
public class ASTvoid_func_func_id extends SimpleNode {
  ...
  public ASTvoid_func_func_id(int id) {
    super(id);
  }

  public ASTvoid_func_func_id(Kleene p, int id) {
    super(p, id);
  }
