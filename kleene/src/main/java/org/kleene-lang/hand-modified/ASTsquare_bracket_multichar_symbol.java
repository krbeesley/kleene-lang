...
//	ASTsquare_bracket_multichar_symbol.java
//
...
public class ASTsquare_bracket_multichar_symbol extends SimpleNode {
  ...
  public ASTsquare_bracket_multichar_symbol(int id) {
    super(id);
  }

  public ASTsquare_bracket_multichar_symbol(Kleene p, int id) {
    super(p, id);
  }
