...
public class ASTmultichar_symbol extends SimpleNode {
  ...
  public ASTmultichar_symbol(int id) {
    super(id);
  }

  public ASTmultichar_symbol(Kleene p, int id) {
    super(p, id);
  }
