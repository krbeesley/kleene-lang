...
public class ASTnet_list_func_func_id extends SimpleNode {
  ...
  public ASTnet_list_func_func_id(int id) {
    super(id);
  }

  public ASTnet_list_func_func_id(Kleene p, int id) {
    super(p, id);
  }
