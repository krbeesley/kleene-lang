...
public class ASThex_int_literal extends SimpleNode {
    ...
    // these ints are node ids
  public ASThex_int_literal(int id) {
    super(id);
  }

  public ASThex_int_literal(Kleene p, int id) {
    super(p, id);
  }
