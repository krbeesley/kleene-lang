...
public class ASTdouble_quoted_char extends SimpleNode {
  ...
  public ASTdouble_quoted_char(int id) {
    super(id);
  }

  public ASTdouble_quoted_char(Kleene p, int id) {
    super(p, id);
  }
