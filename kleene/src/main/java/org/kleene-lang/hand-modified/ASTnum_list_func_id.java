...
public class ASTnum_list_func_id extends SimpleNode {
  ...
  public ASTnum_list_func_id(int id) {
    super(id);
  }

  public ASTnum_list_func_id(Kleene p, int id) {
    super(p, id);
  }
