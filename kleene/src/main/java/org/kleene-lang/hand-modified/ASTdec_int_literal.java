...
public class ASTdec_int_literal extends SimpleNode {
    ...
    // inside Kleene, 'int' values are stored as long
  ...
  public ASTdec_int_literal(int id) {
    super(id);
  }

  public ASTdec_int_literal(Kleene p, int id) {
    super(p, id);
  }
