...
Native Interface
(\acro{jni}).\symbolfootnote[4]{\url{http://www.ibm.com/developerworks/java/tutorials/j-jni/}}  Kleene has its own syntax, based on
...
2\symbolfootnote[7]{\url{http://www.apache.org/licenses/LICENSE-2.0}} on 4 May 2012 by
\init{SAP AG}.\symbolfootnote[8]{\url{http://www.sap.com/}}  The OpenFst library is available
