...
{\Large User Documentation, Version 0.9.3.5}\\
\mbox{}\\
...
(\fsm{}s), including tokenizers, spelling checkers, spelling correctors,
...
Kleene runs on OS X and Linux, requiring Java version 1.5 or higher. 
...
programming, those who have no programming experience at all, in a language
...
\begin{quote}
Lauri Karttunen, M\r{a}ns Huld\'en, Paola Nieddu, Phil Sours, André Kempe, 
Mike Wilkens,
Kemal Oflazer
\end{quote}
...
\include{chapt5}	% Arithmetic Expressions
\include{chapt6}	% Lists
\include{chapt7}	% Other Syntax
\include{chapt8}	% Code Generation and Runtime Code
\include{chapt9}	% RTN Support
%include{chapt9b}	% SAP-style (Phil Sours) RTN support  saprtn.tex.notrack

\include{chapt10}	% Unicode Support
\include{chapt11}	% Conclusion
