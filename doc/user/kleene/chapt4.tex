...
\acro{double low line},  indicates that the context or contexts are to be interpreted as
...
In the traditional alternation rules that we have seen so far, the left-hand side of the rule always
...
copy of the input expression.  The following rule puts \init{xml}-like \verb!<v>! and
